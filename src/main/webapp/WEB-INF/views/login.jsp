...
<main class="bg-gray-50 dark:bg-gray-900">
    <div class="flex flex-col items-center justify-center px-6 mx-auto md:h-screen pt:mt-0 dark:bg-gray-900">
        <a href="../trang-chu" class="flex items-center justify-center mb-8 text-2xl font-semibold lg:mb-10 dark:text-white">
            <img src="https://i.pinimg.com/564x/72/e1/a5/72e1a5c18df81e70094985ef24f5d437.jpg" class="mr-4 h-11" alt="FlowBite Logo">
            <span>BBook</span>
        </a>
        <!-- Card -->
